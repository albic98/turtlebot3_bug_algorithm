...
class Dist:
    ...
    def update(self, msg):
        ...
        newfront = min(getmin(330, 360), getmin(0, 30)) # front angles are 0-30 and 330-360, overall 60 degrees
        newleft = getmin(30, 90)                        # left degrees are between 30 and 90 degrees
        newright = getmin(270, 330)                     # right degrees are between 270 and 330 degrees
        new_backleft = getmin(90, 110)                  # backleft degrees are between 90 and 110 degrees
        new_backright = getmin(250 ,270)                # backright degrees are between 250 and 270 degrees
